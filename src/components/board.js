...
export default function Board() {
  ...
  let nextPlayerInfo = "Player X";
  if (player === 0) {
    nextPlayerInfo = "Player O";
  } else {
    nextPlayerInfo = "Player X";
  }
    ...
    <div className="game-board">
      ...
      <div id="info">
        {/* 
            ...
            */}
        <h1 id="turn">Next Play: {nextPlayerInfo} </h1>
        <h1>{status}</h1>
      </div>
    </div>
  );
